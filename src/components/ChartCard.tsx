...
export function ChartCard({ title, subtitle, height = 260, children }: ChartCardProps) {
  return (
    <div
      className="rounded-2xl border border-[var(--border)] bg-[var(--surface-1)] p-4 flex flex-col gap-2 transition-shadow duration-200 hover:shadow-[var(--shadow-card-hover)]"
