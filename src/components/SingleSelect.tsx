...
export function SingleSelect<T extends string>({ label, options, value, onChange }: SingleSelectProps<T>) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        <span className="text-[var(--text-primary)] font-medium truncate max-w-[100px]">{current?.label ?? "—"}</span>
        <ChevronDownIcon
          size={14}
